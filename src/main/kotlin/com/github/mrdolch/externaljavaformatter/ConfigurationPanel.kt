...
internal class ConfigurationPanel(private val project: Project) : BaseConfigurable(), SearchableConfigurable {
    ...
    override fun createComponent(): JComponent {
        panel.layout = GridLayoutManager(8, 2, JBUI.emptyInsets(), -1, -1)
        panel.add(
        ...
        panel.add(JLabel("Classpath"), left(1))
        ...
        panel.add(JLabel("VM-Options"), left(4))
        panel.add(vmOptions, right(4, Dimension(50, 50)))
        panel.add(JLabel("Test-Code"), left(5))
        panel.add(testCode, right(5, Dimension(50, 50)))
        panel.add(JButton("Test"), left(6))
        panel.add(JLabel(""), left(6))
        panel.add(
            Spacer(), GridConstraints(
                7, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL,
